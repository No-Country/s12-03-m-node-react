...
function Footer() {
	...
	return (
		<footer className="bg-[#37474F] flex flex-row lg:justify-between justify-center px-28 py-16">
			<div className="  px-6 flex-col font-inter  ">
				...
				<div className=" text-[#D1D5DB] flex h-unit-15 text-sm font-normal ">
					<span className=" pt-7">© 2023 Rastrea Patitas. Todos los derechos Reservados</span>
				</div>
			</div>
