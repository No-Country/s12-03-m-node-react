...
const MyPetsStatus = () => {
  ...
  return (
    <div className='w-[336px] md:w-screen h-auto flex flex-col items-left md:items-center bg-[url("/src/assets/bg-patitas.svg")] m-3'>
      ...
      <h3 className='text-slate-700 font-lato text-base font-light leading-7'>Mis mascotas registradas ({userPets?.length})</h3>

      {userPets?.map((pet) => <RegisteredPetCard key={pet._id} petData={pet} />)}
